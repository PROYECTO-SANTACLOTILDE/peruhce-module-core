 ...
 */
package org.openmrs.module.peruhcemodulecore.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.PeruhcemodulecoreController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class PeruhcemodulecoreController {
